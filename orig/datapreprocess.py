...
def preprocess_month(month):
    ...
    processed_data = (
        data.pipe(time_columns_to_datetime)
            ...
            .pipe(add_station_data_to_traffic_data)
...
def add_station_data_to_traffic_data(df):
    station_data = get_station_data()

    # We don't need these columns for the traffic data
    station_data = station_data.drop([COLUMN_STATION_FID_OLD, COLUMN_STATION_NAME_FINNISH_OLD, COLUMN_STATION_NAME_SWEDISH_OLD, 
